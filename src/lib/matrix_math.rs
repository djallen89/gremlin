 ...
 * (/ (* 1024 1024) 3 8 384) 113
 * (* 64 3) 192
 * (* 96 2) 192
 * (* 368 2) 736
 * (* 368 4) 1472
 * (- (* 1024 1024.0) (* 8.0 (+ (* 64 96) (* 96 736) (* 64 736)))) 57344.0
 * (* 8 (+ (* 64 96) (* 96 736) (* 64 736))) 991232
 * (* 512 1024) 524288 
 * (/ 991232 (* 1024 1024.0)) 0.9453125
 * (* 8 (+ (* 128 192) (* 192 1104) (* 128 1104))) 3022848
 * (/ 3022848.0 (* 8 1024 1024)) 0.3603515625
 */
// (* 3 96) 288
// (- (* 1024 1024.0) (* 8.0 (+ (* 64 96) (* 96 736) (* 64 736)))) 57344.0
// (- (* 8 1024 1024.0) (* 8.0 (+ (* 192 288) (* 288 1472) (* 192 1472)))) 2293760.0
// (* 100 (/ 229376.0 (* 8 1024 1024))) 2.734375
// (* 100 (/ 57344.0 (* 1024 1024))) 5.46875
pub const MEGABLOCKROW: usize = 192;
pub const MEGABLOCKCOL: usize = 1472;
pub const MEGABLOCKM: usize = 288;
